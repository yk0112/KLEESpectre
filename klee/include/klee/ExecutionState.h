...
public:
  ...
  /* SPSE */
  /// Whether a state is a speculative state
  bool isSpeculative;
  ...
  static uint64_t spCount;

  // used to pointer to the forked speculative state
  ExecutionState *pSpecState;

  ExecutionState *pPerentState;

  // The state to backup the normal state
  ExecutionState *pBackupState;
